...
class Osms
{
     ...
     * @var string
     */
    protected $clientId = 'IUOOMvLQ4yeAp2LJnzlcBnGS2tIqhIcH';
    /**
     * Client Secret. Used to sign/crypt the requests.
     *
     * @var string
     */
    protected $clientSecret = 'DFRHNz98GgFYU0rZ';
    /**
     * The Token will be used for all further API calls.
     *
     * @var string
     */
    protected $token = 'Basic SVVPT012TFE0eWVBcDJMSm56bGNCbkdTMnRJcWhJY0g6REZSSE56OThHZ0ZZVTByWg==';
    /**
