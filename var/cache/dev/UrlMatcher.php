...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/login_chec' => [[['_route' => 'login', '_controller' => 'App\\Controller\\UtilisateurController::token'], null, ['POST' => 0], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        69 => [[['_route' => 'modif_user', '_controller' => 'App\\Controller\\SuperAdminController::update'], ['id'], ['PUT' => 0], null, false, true, null]],
        ...
        138 => [[['_route' => 'api_doc', '_controller' => 'api_platform.action.documentation', '_format' => '', '_api_respond' => 'true'], ['_format'], null, null, false, true, null]],
        172 => [
